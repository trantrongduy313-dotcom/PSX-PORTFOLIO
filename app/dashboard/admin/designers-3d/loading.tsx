export default function Designers3dLoading() {
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "100%", background: "var(--cream)" }}>
      <div style={{ flexShrink: 0, padding: "16px 24px", borderBottom: "1px solid var(--border)", background: "var(--cream-card)" }}>
        <div style={{ height: "24px", width: "200px", background: "var(--cream-dark)", borderRadius: "2px" }} className="psx-shimmer" />
        <div style={{ height: "11px", width: "140px", background: "var(--cream-dark)", borderRadius: "2px", marginTop: "6px" }} className="psx-shimmer" />
      </div>
      ...
      <div style={{ flex: 1, overflow: "hidden" }}>
        {Array.from({ length: 10 }).map((_, i) => (
          <div key={i} style={{ display: "flex", gap: "20px", padding: "11px 24px", borderBottom: "1px solid var(--border)", alignItems: "center" }}>
            <div style={{ height: "12px", width: "140px", background: "var(--cream-dark)", borderRadius: "2px" }} className="psx-shimmer" />
